...
public class Msgs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DriverMapActivity.msgcount=0;
        DriverMapActivity.txtmsgcount.setText(String.valueOf(DriverMapActivity.msgcount));
        DriverMapActivity.txtmsgcount.setVisibility(View.GONE);
        ...
        btnsend.setOnClickListener(v -> {
            ...
            userMap.put("CID", Common_Var.customerID);
                ...
                if (dataSnapshot.exists()) {
                    for (DataSnapshot postSnapShot : dataSnapshot.getChildren()) {
                        if (postSnapShot.getKey().equals("CID")) {
                            ...
                            if (value1.equals(Common_Var.customerID)) {
