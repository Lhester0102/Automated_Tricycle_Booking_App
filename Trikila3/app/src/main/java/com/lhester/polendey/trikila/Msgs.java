...
public class Msgs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference()
                ...
                .child("Messages");
        if(CustomerMapActivity.txtmsgcount!=null) {
            CustomerMapActivity.msgcount = 0;
            CustomerMapActivity.txtmsgcount.setText(String.valueOf(CustomerMapActivity.msgcount));
            CustomerMapActivity.txtmsgcount.setVisibility(View.GONE);
        }
