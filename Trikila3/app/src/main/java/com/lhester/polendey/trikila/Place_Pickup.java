...
public class Place_Pickup extends FragmentActivity implements OnMapReadyCallback, PermissionsListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Mapbox.getInstance(Place_Pickup.this, getString(R.string.access_token));
        setContentView(R.layout.activity_place__pickup);
        ...
        btnSetDes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Common_Variables.customer_pickuploaction = new com.mapbox.mapboxsdk.geometry.LatLng(latLng);
                ...
                NewRide.fr.setText(pick_address);
        ...
        switch (requestCode) {
            case REQ_PERMISSION: {
                if (grantResults.length > 0
                    ...
                    Intent intent = new Intent(Place_Pickup.this, logincustomer.class);
...
// Move map camera to the selected location
    ...
    public void onMapReady(@NonNull final MapboxMap mapboxMap) {
        Place_Pickup.this.mapboxMap = mapboxMap;
...
// Check if permissions are enabled and if not request
        if (PermissionsManager.areLocationPermissionsGranted(Place_Pickup.this)) {
...
// Set the LocationComponent activation options
            LocationComponentActivationOptions locationComponentActivationOptions =
                    LocationComponentActivationOptions.builder(Place_Pickup.this, loadedMapStyle)
...
// Set the component's render mode
            ...
            permissionsManager = new PermissionsManager(Place_Pickup.this);
            permissionsManager.requestLocationPermissions(Place_Pickup.this);
        }
    }
    ...
    private void initLocationEngine() {
        locationEngine = LocationEngineProvider.getBestLocationEngine(Place_Pickup.this);
    ...
    public void onPermissionResult(boolean granted) {
        if (granted) {
            ...
            Toast.makeText(Place_Pickup.this, R.string.user_location_permission_not_granted, Toast.LENGTH_LONG).show();
            finish();
        }
    }
